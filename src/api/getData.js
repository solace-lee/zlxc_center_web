...
export const login = data => fetch('/api/auth/accredit', data, 'POST');
/**
 * 退出
 */
...
export const getAdminInfo = () => fetch('/api/auth/accredit');
...
export const userCount = date => fetch('http://elm.cangdu.org/statis/user/' + date + '/count');

/**
 * 某一天订单数量
 */

export const orderCount = date => fetch('http://elm.cangdu.org/statis/order/' + date + '/count');
...
export const adminDayCount = date => fetch('http://elm.cangdu.org/statis/admin/' + date + '/count');

/**
 * 管理员列表
 */

export const adminList = data => fetch('http://elm.cangdu.org/admin/all', data);

/**
 * 管理员数量
 */

export const adminCount = () => fetch('http://elm.cangdu.org/admin/count');
